...
export default function About() {
  return (
    <>
      {/* About Section */}
      <section className="about py-16 md:py-24 lg:py-32 xl:py-[200px] px-4 md:px-6 lg:px-8 xl:px-12 bg-gradient-to-b from-amber-50 to-orange-50 h-full">
        <div className="">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 xl:gap-20 ">
            ...
            <div className="order-2 lg:order-1 h-full">
              ...
              leading-[64px] mb-8 md:mb-12 lg:mb-16 xl:mb-[283px] lg:max-w-[73%]"
              >
