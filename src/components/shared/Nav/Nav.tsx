    ...
    <>
      <div className="flex justify-center">
        <motion.header
          ...
          className="pt-4 md:pt-5  px-4 md:px-6 fixed z-1 w-[300px] sm:w-[500px]  md:w-[700px] mx-auto"
        >
          <div className="bg-[#f8ede3]  flex justify-between items-center py-2 md:py-1 px-4 md:px-2 md:pl-5 rounded-md shadow-lg">
            {/* Logo */}
            <Link
              href="/"
